...
class FavoritePoemTableVC: FilterableTableView {
    override func viewDidLoad() {
        self.placeholderText = "Search Favorites"
        self.tableView.register(UINib(nibName: "PoemListItem", bundle: nil), forCellReuseIdentifier: "Cell")
        self.unfilteredList = [] // TODO: favorites, not all
...
//        self.performSegue(withIdentifier: AthleteListVC.toDetail, sender: selectedCell)
    }
...
//        if let dest = segue.destination as? AthleteDetailVC {
